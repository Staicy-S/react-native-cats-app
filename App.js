          ...
          <View style={isLandscape ? styles.mainLandscape : styles.main}>
            ...
            >
              ...
              <Text style={styles.paragraph}>
                Cats are very lovely animals. Treat them with kindness and
                respect and they will reward you with affection! Sometimes, you
                can meet cats in the wild.{"\n"}
                {"\n"}I have been friends with a cat for a very long time,
                nearly 10 years, until she unfortunately passed away. I
                encountered him every week before going to work. He was a very
                big cat! He loved my backpack and took many opportunities to
                make himself comfortable on it. {"\n"}
                {"\n"}You never know if a cat you meet might become a dear
                friend to you. So enjoy every cat encounter you can get 😻
              </Text>
            </View>
            <Image
